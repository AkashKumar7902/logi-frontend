      ...
      <Card className="w-full max-w-md">
        <CardBody className="p-7">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-semibold text-ink-900 dark:text-ink-50">Welcome back</h2>
            <p className="mt-1 text-sm text-ink-500 dark:text-ink-400">
              Sign in to your Logi account to continue
            </p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-ink-600 dark:text-ink-300">
            New to Logi?{' '}
            <Link to="/register/user" className="text-brand-600 font-medium hover:text-brand-700 hover:underline dark:text-brand-400 dark:hover:text-brand-300">
              Create an account
            </Link>
          </p>
        </CardBody>
